    ...
    public sealed class MyStrategy : IStrategy
    {
        ...
        private ITurn TryBlockAir()
        {
            ...
            if (_BallXYZ.Z > ballInterceptionHeight && _BallXY.Y > _RobotXY.Y) //TODO !!!
            {
                ...
                for (var dt = minReactionTime; dt <= maxReactionTime; dt += dtStep)
                {
                    ...
                    var ballVel = new Vector3(_BallVel.X, _BallVel.Y, _Physics.GetZVelAfter(dt, _BallVel.Z) * 0.75f); //TODO ÏÎÕÎÄÓ ÒÓÒ ÑÊÎÐÎÑÒÜ ÏÎ x È y ÍÅ ÒÀ 0.25f
        ...
        private ITurn PlayForward()
        {
            ...
            if (_BallXYZ.Z > _BallLandingPredictionMinHeight)
            {
                ...
                ballPos = Vector2.Lerp(_BallXY, ballPos, ratio); //TODO Êîñòûëü? Èçó÷èòü.
            ...
            var normalizer = _BallXYZ.Z > DecelerationBallMinHeight && targetPosR.Length() < DecelerationToTargetPosDist ? DecelerationRate : 1; //TODO Ñäåëàòü íåðàâíîìåðíûé ðàçãîí.
